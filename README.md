...
### Data
Input and processed datasets are stored in the [Terra folder](https://github.com/gitfrid/CzechFOI-DRATE-OPENSCI/tree/main/Terra). These include age-specific CSV mortality files created and used by the scripts.
